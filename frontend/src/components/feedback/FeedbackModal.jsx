...
export const useFeedbackModal = () => {
  ...
  const showSuccess = React.useCallback((title, message, actionLabel, onAction) => {
    setModalState({
      isOpen: true,
      type: 'success',
      title,
  ...
  const showError = React.useCallback((title, message, actionLabel, onAction) => {
    setModalState({
      isOpen: true,
      type: 'error',
      title,
  ...
  const showWarning = React.useCallback((title, message, actionLabel, onAction) => {
    setModalState({
      isOpen: true,
      type: 'warning',
      title,
