 ...
 * Canonical orchestrator tab for Brand Frames Studio Management.
 * Coordinates canvas engine, transparent PNG overlay export, presets, and frame library.
 */
export const AdminFramesTab = () => {
  ...
  // Pagination & Search State for Frames Library
  ...
  // Export and publish Canva-designed frame
  const handlePublishCanvaFrame = async () => {
    ...
    try {
      ...
      // Export 100% clean 1080x1080 preview without edit lines or selection handles
